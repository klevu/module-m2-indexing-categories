...
namespace Klevu\IndexingCategories\Test\Integration\Setup\Patch\Data;

use Klevu\IndexingCategories\Constants;
use Klevu\IndexingCategories\Setup\Patch\Data\MigrateLegacyConfigurationSettings;
...
class MigrateLegacyConfigurationSettingsTest extends TestCase
{
     ...
     */
    public function testApply_MigrateCategorySyncEnabled_EnabledGlobal(): void
    {
        ...
        $this->configWriter->save(
            path: MigrateLegacyConfigurationSettings::XML_PATH_LEGACY_CATEGORY_SYNC_ENABLED,
            value: '1',
     ...
     * @magentoDbIsolation enabled
     */
    public function testApply_MigrateCategorySyncEnabled_DisabledGlobal(): void
    {
        $this->deleteExistingKlevuConfig();
     ...
     * @magentoDbIsolation enabled
     */
    public function testApply_MigrateCategorySyncEnabled_EnabledWebsite(): void
    {
        $this->deleteExistingKlevuConfig();
     ...
     * @magentoDbIsolation enabled
     */
    public function testApply_MigrateCategorySyncEnabled_DisabledWebsite(): void
    {
        $this->deleteExistingKlevuConfig();
     ...
     * @magentoDbIsolation enabled
     */
    public function testApply_MigrateCategorySyncEnabled_EnabledStore(): void
    {
        $this->deleteExistingKlevuConfig();
     ...
     * @magentoDbIsolation enabled
     */
    public function testApply_MigrateCategorySyncEnabled_DisabledStore(): void
    {
        $this->deleteExistingKlevuConfig();
    ...
    private function assertInitialConfig(bool $enabled = true): void
    {
        $enabledGlobally = $this->scopeConfig->isSetFlag(
            MigrateLegacyConfigurationSettings::XML_PATH_LEGACY_CATEGORY_SYNC_ENABLED,
            ScopeConfigInterface::SCOPE_TYPE_DEFAULT,
        );
        $enabled
