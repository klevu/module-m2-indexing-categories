...
class SyncEntitiesCommandTest extends TestCase
{
    ...
    public function testExecute_Failure_ForCategories_AddAndUpdate(): void
    {
        ...
        $pattern = '#Action: KLEVU_CATEGORY::delete#';
        $matches = [];
        preg_match(
            pattern: $pattern,
            subject: $display,
        ...
        $this->assertCount(0, $matches, 'KLEVU_CATEGORY::delete batches');
    ...
    public function testExecute_Succeeds_ForCategories_Delete(): void
    {
        ...
        $pattern = '#Action: KLEVU_CATEGORY::add#';
        $matches = [];
        preg_match(
            pattern: $pattern,
            subject: $display,
        ...
        $this->assertCount(0, $matches, 'KLEVU_CATEGORY::add batches');
        ...
        $pattern = '#Action: KLEVU_CATEGORY::update#';
        $matches = [];
        preg_match(
            pattern: $pattern,
            subject: $display,
        ...
        $this->assertCount(0, $matches, 'KLEVU_CATEGORY::update batches');
