...
use Klevu\IndexingCategories\Service\Provider\EntityProviderProvider as EntityProviderProviderVirtualType;
...
class EntityProviderProviderTest extends TestCase
{
    ...
    public function testGet_ReturnsArrayOfProviders(): void
    {
        ...
        foreach ($keys as $key) {
            ...
            $this->assertInstanceOf(expected: CategoryEntityProvider::class, actual: $result[$key]);
        }
    }
}
