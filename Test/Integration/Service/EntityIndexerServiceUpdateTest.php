...
use Klevu\IndexingCategories\Service\EntityIndexerService\Update as EntityIndexerServiceVirtualType;
...
class EntityIndexerServiceUpdateTest extends TestCase
{
    ...
    public function testExecute_ReturnsNoop_WhenNoCategoriesToUpdate(): void
    {
        $apiKey = 'klevu-js-key';
        $this->cleanIndexingEntities(apiKey: $apiKey);
     ...
     * @magentoDbIsolation disabled
     */
    public function testExecute_ReturnsSuccess_WhenCategoryUpdated(): void
    {
        $apiKey = 'klevu-123456789';
